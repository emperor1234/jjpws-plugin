...
<table width="600" cellpadding="0" cellspacing="0" style="margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;">
    ...
    <tr><td style="padding:32px;">
        ...
        <table width="100%" cellpadding="8" cellspacing="0" style="border:1px solid #e5e5e5;border-radius:6px;margin:20px 0;">
            ...
            <tr><td><strong>Name</strong></td><td><?php echo esc_html( $customer_name ?: '—' ); ?></td></tr>
            <tr style="background:#f9f9f9;"><td><strong>Email</strong></td><td><?php echo esc_html( $customer_email ); ?></td></tr>
            <tr><td><strong>Phone</strong></td><td><?php echo esc_html( $customer_phone ?: '—' ); ?></td></tr>
            <?php if ( $address && $address !== ',' ) : ?>
            <tr style="background:#f9f9f9;"><td><strong>Address</strong></td><td><?php echo esc_html( $address ); ?></td></tr>
            <?php endif; ?>
            <?php if ( ! empty( $lot_size_acres ) ) : ?>
            <tr><td><strong>Lot Size</strong></td><td><?php echo esc_html( $lot_size_acres ); ?> acres</td></tr>
            <?php endif; ?>
            <?php if ( ! empty( $dog_count ) ) : ?>
            <tr style="background:#f9f9f9;"><td><strong>Dogs</strong></td><td><?php echo absint( $dog_count ); ?></td></tr>
            <?php endif; ?>
            <?php if ( ! empty( $distance_miles ) ) : ?>
            <tr><td><strong>Distance</strong></td><td><?php echo esc_html( $distance_miles ); ?> miles</td></tr>
            <?php endif; ?>
        </table>
        <h3>Message</h3>
        <p style="background:#f9f9f9;padding:12px;border-radius:4px;white-space:pre-wrap;"><?php echo esc_html( $message ); ?></p>
